...
Rminibwa starts as a small R interface to the `minibwa` executable. The package
can be installed and checked without `minibwa`, but mapping functions need an
...
The CLI layer is intentionally thin. It should stay close to upstream behavior
and serve as the validation oracle for future native bindings.
