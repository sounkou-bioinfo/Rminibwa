...
returns captured output when `output = NULL` and writes to a file when
`output` is supplied.
...
3.  expose
    ...
    through [`.Call()`](https://rdrr.io/r/base/CallExternal.html) with
    raw-byte inputs and native columnar batches;
